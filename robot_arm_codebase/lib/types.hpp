...
struct MotorPosition
{
    ...
    MotorPosition(double pos1, double pos2, double pos3, double pos4, double pos5, double pos6) : pos1(pos1), pos2(pos2), pos3(pos3), pos4(pos4), pos5(pos5), pos6(pos6) {}
...
struct JointAngle
{
    ...
    JointAngle() = default;
    JointAngle(double theta1, double theta2, double theta3, double theta4, double theta5, double theta6) : theta1(theta1), theta2(theta2), theta3(theta3), theta4(theta4), theta5(theta5), theta6(theta6) {}
